...
import pabd.pindahdb.exceptions.IllegalOrphanException;
import pabd.pindahdb.exceptions.NonexistentEntityException;
import pabd.pindahdb.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pabd_pindahdb_jar_0.0.1-SNAPSHOTPU");
